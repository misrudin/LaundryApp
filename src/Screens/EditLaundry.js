...
import {editLaundry} from '../Public/redux/actions/laundry';
import ImagePicker from 'react-native-image-picker';
import AsyncStorage from '@react-native-community/async-storage';

const EditLaundry = props => {
  ...
  const clear = async () => {
    ...
    setPhone('');
    setImage('');
    await props.navigation.navigate('MyLaundry');
  };
  ...
  const daftar = async () => {
    ...
    await dispatch(editLaundry(id, fd));
    // console.warn(fd);
    // Alert.alert(
    //   'Congratulation',
        ...
        <View style={styles.container}>
          ...
          <View style={styles.imgConatiner}>
            <TouchableOpacity style={styles.img} onPress={showImage}>
              <Image
                source={image ? {uri: image.uri} : {uri: image2}}
                style={styles.images}
              />
          ...
          <View style={styles.botom}>
            ...
            <TouchableOpacity
              onPress={() => props.navigation.navigate('MyLaundry')}>
